...
test_name = "test_1_p1_p99_b32_journal_6bands"
...
print("Unet...")
model_unet = UNet(input_size=(256,256,6), lr=0.0001)
model_unet.summary()
...
# Train U-Net with generator
print("A-Unet...")
model_am_unet = UNetAM(input_size=(256,256,6), lr=0.0001, batch_size=32)
...
print("Resnet...")
model_resnet50segnet = ResNet50SegNet(input_size=(256,256,6), lr=0.0001)
...
# FCN32
print("FCN32...")
model_fcn_32 = fcn_32(input_size=(256,256,6), lr = 0.0001)
