...
dataset_name = "dataset_02_mean" # 2020
test_name = "test_1_p1_p99_b32_journal_2019_2020"
...
current_model_dir = f"{results_dir}/dataset_02_mean_2019/test_1_p1_p99_b32_journal"
...
# load models
unet = load_model(f'{current_model_dir}/{unet_sent1_model_name}',compile=False)
attention_unet = load_model(f'{current_model_dir}/{am_unet_sent1_model_name}', compile=False)
resnet_segnet = ResNet50SegNet2D(input_size=(256,256,2))
resnet_segnet.load_weights(f'{current_model_dir}/{resnet50segnet_sent1_model_name}')
fcn32 = load_model(f'{current_model_dir}/{fcn32_sent1_model_name}', compile=False)
